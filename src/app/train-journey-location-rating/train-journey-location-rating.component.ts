...
@Component({
  selector: 'app-train-journey-location-rating',
  templateUrl: './train-journey-location-rating.component.html',
  styleUrls: ['./train-journey-location-rating.component.scss']
})
export class TrainJourneyLocationRatingComponent implements OnInit {

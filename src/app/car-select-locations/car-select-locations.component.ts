...
@Component({
  selector: 'app-car-select-locations',
  templateUrl: './car-select-locations.component.html',
  styleUrls: ['./car-select-locations.component.scss']
})
export class CarSelectLocationsComponent implements OnInit {
  route: any;
  locArray: Array<any> = [];
  locPage: Array<any> = [];
  prefs = preferences;
